...
import { AdmissionApplySchema } from '../dtos/createAdmission.dto';
...
router.post('/apply', validate(AdmissionApplySchema), (req, res, next) => { admissionController.apply(req, res, next) });
